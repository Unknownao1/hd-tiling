...
<section className="hero" id="home">
    <img className="hero-bg" src="/images/p5.jpg" alt="JMB Design and Build - Hertfordshire"/>
    <div className="hero-overlay"/>
    <div className="hero-name">
    <h1>JMB<span className="line2">Design &amp; Build</span></h1>
    </div>
    </section>
...
<section className="why-us">
  <div className="why-us-image"><img src="/images/p4.jpg" alt="JMB craftsmanship"/></div>
...
<section className="testimonial">
  ...
  <blockquote>&ldquo;A very professional service. James and the team transformed our property into exactly what we had hoped for and all within the initial fee scope. Delighted with the outcome. Hardworking, honest, and the quality of the finish is outstanding &mdash; we have recommended JMB to friends!&rdquo;</blockquote>
...
<div className="badges">
  ...
  <span className="badge gold">&#9733;&#9733;&#9733;&#9733;&#9733; Houzz Award 2022&ndash;2026</span>
...
<p>From full extensions to loft conversions, renovations and groundwork &mdash; JMB Design &amp; Build is here to guide you through every step of the process.</p>
<p><strong>Get in touch with our team today!</strong></p>
  <a href="mailto:info@jmbdesignandbuild.co.uk" className="cta-btn">Contact Us</a>
  </section>
...
<iframe className="map-embed" title="JMB Location" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2462.7!2d-0.1757!3d51.6978!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4876172b8c3a1f41%3A0x0!2s14+The+Service+Road%2C+Potters+Bar+EN6+1QA!5e0!3m2!1sen!2suk!4v1717700000000" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"/>
  </section>

<footer>
  <div className="footer-inner">
  <p className="footer-copy">&copy; 2026 JMB Design &amp; Build Ltd. All Rights Reserved.</p>
...
<a href="https://www.instagram.com/direct/t/110683106996382/" target="_blank" rel="noopener noreferrer" aria-label="Message">
